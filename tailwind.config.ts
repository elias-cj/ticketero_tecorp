  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        alert: {
          banner: "hsl(var(--alert-banner) / <alpha-value>)",
          "banner-foreground": "hsl(var(--alert-banner-foreground) / <alpha-value>)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
